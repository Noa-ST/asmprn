import React, { useEffect, useState, JSX } from "react"; // Bổ sung JSX
import api from "../api";
...
interface Order {
  ...
  totalAmount: number;
  status: string;
  orderDate: string; // Tên thuộc tính này khớp với Order.cs đã sửa
  products: OrderItem[]; // Tên thuộc tính này khớp với OrdersController.cs
}
...
function statusBadge(status?: string) {
  ...
  // Khai báo type cho map sử dụng JSX.Element
  const map: Record<
    string,
